...
<!-- Mirrored from vetra.laborasyon.com/demos/default/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jun 2024 13:07:37 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div class="card">
                <div class="row g-0">
                    <div class="col">
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
                                ...
                                <form action="login-info.php" method="post" class="mb-5">
                                    <div class="mb-3">
                    ...
                    <div class="col d-none d-lg-flex border-start align-items-center justify-content-between flex-column text-center">
                        <div class="logo">
                            <img width="120" src="asset/img/logo/logo.png" alt="logo">
                        </div>
                        <div>
                            <h3 class="fw-bold">Welcome to eprime!</h3>
...
<!-- Mirrored from vetra.laborasyon.com/demos/default/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jun 2024 13:07:38 GMT -->
</html>
